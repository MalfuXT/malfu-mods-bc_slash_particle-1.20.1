...
public class SlashParticle180 extends SpriteBillboardParticle {
    ...
    SlashParticle180(ClientWorld world, double x, double y, double z,
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        Vector4f[] corners = {
                new Vector4f(-size, 0, -size, 1), // Bottom-left
                new Vector4f(-size, 0,  size, 1), // Bottom-right
                new Vector4f( size, 0,  size, 1), // Top-right
                new Vector4f( size, 0, -size, 1)  // Top-left
        };
    ...
    public static class Provider implements ParticleFactory<SlashParticleEffect> {
        ...
        public Particle createParticle(SlashParticleEffect settings, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            return new SlashParticle180(clientWorld, d, e, f,
